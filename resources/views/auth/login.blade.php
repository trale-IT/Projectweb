                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                <img src="https://cdn-icons-png.freepik.com/512/4945/4945750.png" alt="logo" >
                            </div>
                            ...
                            <form class="pt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="">Đăng nhập</button>
                                </div>
